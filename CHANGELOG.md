...
- `Rack::Multipart::UploadedFile#method_missing` now correctly forwards keyword arguments ([#2481](https://github.com/rack/rack/pull/2481), [@jeremyevans](https://github.com/jeremyevans))
