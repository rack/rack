...
describe Rack::Server do
  ...
  it "only provide default middleware for development, deployment, and production environments" do
    Rack::Server.default_middleware_by_environment.keys.sort.must_equal %w(deployment development production)
  end
