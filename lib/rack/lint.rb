  ...
  class Lint
    ...
    class Wrapper
      ...
      def check_environment(env)
        ...
        ## <tt>rack.hijack</tt>:: See below, an object responding to #call that
        ##                        is used to hijack the current request,
        ##                        returning an IO-like stream object.
      ...
      ##
      ## Full hijacking only works with HTTP/1. Partial hijacking has been
      ## superseeded by streaming responses.
      ##
      ## ==== Full Hijack
      ##
      ## Full hijack is typically used when the application wants to upgrade an
      ## HTTP/1 connection to a different protocol (e.g. Websocket). It occurs
      ## before any headers are written and causes the request to ignores any
      ...
      ## ==== Partial Hijack
      ##
      ## The partial hijack is used for bi-directional streaming of the
      ## request and response body. It occurs after the status and headers are
      ## written by the server and causes the server to ignore the Body of the
      ## response.
      ##
