  ...
  class Lint
    ...
    class Wrapper
      ...
      def check_environment(env)
        ...
        ##
        ## The CGI keys (named without a period) must have String values and are reserved for the Rack specification. If the string values for CGI keys contain non-ASCII characters, they should use ASCII-8BIT encoding.
        ...
        ##
        ## See {RFC 9110}[https://datatracker.ietf.org/doc/html/rfc9110#name-host-and-authority] for more details on the format of <tt>SERVER_NAME</tt>.
        ...
        ## ==== +HTTP_HOST+
        ##
        ## An optional string, representing the HTTP authority, as defined by {RFC 9110}[https://datatracker.ietf.org/doc/html/rfc9110#name-host-and-authority].
      ...
      def check_headers(headers)
        ...
        headers.each do |key, value|
          ...
          ## * The headers must not contain a +status+ key.
